    ...
    if #[cfg(feature = "ssr")] {
        ...
        fn get_language_model() -> Llama {
            ...
            let model_parameters = llm::ModelParameters {
                ...
                use_gpu: true,
                lora_adapters: None,
                gpu_layers: Some(0), // Provide appropriate default value
                n_gqa: Some(0), // Provide appropriate default value
                rope_overrides: None, // Provide appropriate default value
            };
